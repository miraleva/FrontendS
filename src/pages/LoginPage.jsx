    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative font-sans bg-transparent">
      ...
      <div className="relative z-20 w-full max-w-[520px] bg-white/40 backdrop-blur-md border border-white/30 dark:bg-slate-900/50 dark:border-slate-800/40 rounded-3xl sm:rounded-[32px] shadow-[0_8px_32px_rgba(0,0,0,0.1)] p-4 sm:p-6 animate-fade-in my-16 sm:my-4">
        ...
        <div className="text-center mb-4">
          <h1 className="text-[26px] md:text-[28px] font-bold tracking-tight text-slate-900 dark:text-white mb-1 font-display transition-all">
        ...
        {/* ADMIN GİRİŞ FORMU */}
        {isAdminMode ? (
          <form onSubmit={handleAdminSubmit} onKeyDown={handleFormKeyDown} className="flex flex-col gap-2.5">
            <div className="flex flex-col gap-1">
              <label htmlFor="adminPassword" className="text-[13px] font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider pl-3">
              ...
              {fieldErrors.admin && (
                <p className="text-[12px] text-red-500 pl-3 mt-0.5">{fieldErrors.admin}</p>
              )}
            </div>
        ...
        {!isAdminMode && !isTwoFactorMode && (
          <div className="mt-4 text-center flex flex-col gap-2">
            ...
            <button
              ...
              className="text-[13px] text-[#f07c24] dark:text-amber-400 hover:text-[#f07c24]/80 dark:hover:text-amber-300 font-bold transition-all duration-200 hover:underline tracking-wide self-center"
            >
